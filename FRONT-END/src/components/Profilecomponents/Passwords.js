...
function details(){
    return(
        ...
        <div className={styles.entire}>
          <h3 style={{ float:'left', marginTop:'-5px',marginLeft:'2%', fontVariant:'lining-nums', color:'teal'}}>Your previous password</h3>
          <div className={styles.password}>
            <label>Previous Password:</label>
            <MDBInput label='Previous Password' type='password' id='formWhite' defaultValue={'StartHub'} readOnly/>
          </div><br/>
          <h3 style={{ float:'left', marginTop:'5px',marginLeft:'2%', fontVariant:'lining-nums', color:'teal'}}>Your current password</h3>
          <div className={styles.password}>
          ...
          <br/><br/>
          <h3 style={{ color: 'red' }}>Have you forgot your password?</h3>
          <br/>
